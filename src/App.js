...
import Legal from "./componnents/pages/Legal";
...
function App() {
  ...
  return (
    <>
      <div
        className={`App flex-shrink-0 d-flex flex-column min-vh-100 ${
      ...
      >
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route
              path="/Expertise"
              element={<Expertise dark={dark} updateDark={updateDark} />}
            />
            ...
            <Route
              ...
              <Route
                path="/Legal"
                element={<Legal dark={dark} updateDark={updateDark} />}
              />
          </Routes>
